...
public class F_aircompanyt_basic_data implements Serializable{
    private Integer id;
    ...
    public F_aircompanyt_basic_data(Integer id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "F_aircompanyt_basic_data{" +
                ...
                ", aln_iod='" + aln_iod + '\'' +
                ", aln_agent='" + aln_agent + '\'' +
                ", aln_terminal='" + aln_terminal + '\'' +
                ", aln_short_chn='" + aln_short_chn + '\'' +
                ", aln_short_eng='" + aln_short_eng + '\'' +
                ", aln_name_chn='" + aln_name_chn + '\'' +
                ", aln_name_eng='" + aln_name_eng + '\'' +
                ", aln_tel='" + aln_tel + '\'' +
                ", aln_dispatcher='" + aln_dispatcher + '\'' +
                ", aln_office='" + aln_office + '\'' +
                ", aln_zcjg='" + aln_zcjg + '\'' +
                ", aln_url='" + aln_url + '\'' +
                ", aln_logo='" + aln_logo + '\'' +
                ", aln_dscrp='" + aln_dscrp + '\'' +
                ", aln_firsttime='" + aln_firsttime + '\'' +
                ", aln_parent_com='" + aln_parent_com + '\'' +
                ", remark1='" + remark1 + '\'' +
                '}';
    }
}