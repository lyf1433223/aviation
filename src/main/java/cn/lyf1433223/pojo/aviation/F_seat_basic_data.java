...
public class F_seat_basic_data{
	...
	public String toString() { 
		return "F_seat_basic_data[id=" + id + ",bay_no=" + bay_no + ",bay_sx=" + bay_sx + ","+
		"bay_tksx=" + bay_tksx + ",bay_jwc=" + bay_jwc + ",bay_jwk=" + bay_jwk + ","+
		"bay_lx=" + bay_lx + ",bay_zjwbm=" + bay_zjwbm + ",bay_yjwbm=" + bay_yjwbm + ","+
		"bay_zt=" + bay_zt + ",bay_yxj=" + bay_yxj + ",remark=" + remark + "]";
	}
}
