...
/**
 * @ClassName:f_flight_report_monthly 
 * @Description: TODO(��˵����f_flight_report_monthly )
 * @author Uncle liu 
...
public class F_flight_report_monthly{
	...
	public F_flight_report_monthly(){
	}
	public F_flight_report_monthly(Integer id,Integer day,Integer flights,Integer passengers,Integer cargo_weight,Integer rtype,String add_time){
		this.id=id;
		this.day=day;
	...
	public String toString() { 
		return "F_flight_report_monthly[id=" + id + ",day=" + day + ",flights=" + flights + ","+
