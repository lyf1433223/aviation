...
public class F_task_basic_data{
	...
	public String toString() { 
		return "F_task_basic_data[id=" + id + ",task_code=" + task_code + ",task_zh_short=" + task_zh_short + ","+
		"task_sort=" + task_sort + ",task_zh=" + task_zh + ",task_en=" + task_en + ","+
		"remark=" + remark + "]";
	}
}
